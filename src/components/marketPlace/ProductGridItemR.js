...
import ViewMoreP from "../../app/routes/components/routes/dialogs/view_moreR";
...
class ProductGridItem extends React.Component {
  ...
  render() {
    // console.log("object", this.props.product.number);
    return (
      <div
      ...
      >
        <Badge
          badgeContent={this.props.product.number}
          color="error"
          max={9999999999}
        >
